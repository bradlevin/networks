...
cclient$(FILE): cclient.c networks.o gethostbyname6.o funcs.o
	$(CC) $(CFLAGS) -o cclient$(FILE) cclient.c networks.o gethostbyname6.o funcs.o$(LIBS)

server$(FILE): server.c networks.o gethostbyname6.o funcs.o
	$(CC) $(CFLAGS) -o server$(FILE) server.c networks.o gethostbyname6.o funcs.o $(LIBS)
